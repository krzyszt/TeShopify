...
namespace TeShopify\Resource;

use TeShopify\Client\Http as ShopifyClient;
...
abstract class Resource {
    ...
    protected function _getClient() {
        if (!$this->_config['client'] instanceof ShopifyClient)
            throw new \Exception('TeShopify\Client\Http object expected, got ' . gettype($this->_config['client']));
